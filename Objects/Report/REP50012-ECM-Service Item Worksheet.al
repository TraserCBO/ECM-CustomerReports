report 50012 "ECM - Service Item Worksheet"
{
    ...
    // ----------------------
    DefaultLayout = RDLC;
    RDLCLayout = 'Objects\Report\ReportLayout\ECM Service Item Worksheet.rdlc';
    ...
    begin
        ...
        THEN BEGIN
            ...
            ECMReportMgt.AddReportOption('ShowComments', ECMReportMgt.GetBooleanValue(ShowComments));
            ServiceItemLine.SETRANGE("Document Type", "Service Item Line"."Document Type");
            ServiceItemLine.SETRANGE("Document No.", "Service Item Line"."Document No.");
            ServiceItemLine.SETRANGE("Line No.", "Service Item Line"."Line No.");
