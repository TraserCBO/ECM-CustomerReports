report 50013 "ECM - Service Contract"
{
    ...
    // ----------------------
    DefaultLayout = RDLC;
    RDLCLayout = 'Objects\Report\ReportLayout\ECM Service Contract.rdlc';
    ...
    begin
        ...
        THEN BEGIN
            ...
            ServiceContractHeader.SETRANGE("Contract Type", "Service Contract Header"."Contract Type");
            ServiceContractHeader.SETRANGE("Contract No.", "Service Contract Header"."Contract No.");
