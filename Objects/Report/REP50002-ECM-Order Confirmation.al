report 50002 "ECM - Order Confirmation"
{
    ...
    // ----------------------
    DefaultLayout = RDLC;
    RDLCLayout = 'Objects\Report\ReportLayout\ECM Order Confirmation.rdlc';
    ...
    begin
        ...
        THEN BEGIN
            ...
            ECMReportMgt.AddReportOption('DisplayAssemblyInformation', ECMReportMgt.GetBooleanValue(DisplayAssemblyInformation));
